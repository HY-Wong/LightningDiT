...
if __name__ == '__main__':
    ...
    vae_high = vae_high.to(args.device)
    vae_high.eval()
    ...
    vae_low = vae_low.to(args.device)
    vae_low.eval()
    ...
    idwt = DWTInverse('haar', mode='zero').to(args.device)
    ...
    if is_main_process():
        ...
        visualize_imgs.save(f'{save_dir}/recon_va-vae-high-low-f16c32.png')
